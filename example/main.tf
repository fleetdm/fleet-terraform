...
module "fleet" {
  ...
  fleet_config = {
    ...
    image = "fleetdm/fleet:v4.76.0" # override default to deploy the image you desire
...
module "migrations" {
  source                   = "github.com/fleetdm/fleet-terraform/addons/migrations?depth=1&ref=tf-mod-addon-migrations-v2.2.1"
