...
| <a name="input_pod_annotations"></a> [pod\_annotations](#input\_pod\_annotations) | Used to populate the annotations for pods. | `map(any)` | `{}` | no |
...
| <a name="input_service_account_annotations"></a> [service\_account\_annotations](#input\_service\_account\_annotations) | Used to populate the annotations for the fleet service account. | `map(any)` | `{}` | no |
| <a name="input_service_annotations"></a> [service\_annotations](#input\_service\_annotations) | Used to populate the annotations for the fleet service. | `map(any)` | `{}` | no |
