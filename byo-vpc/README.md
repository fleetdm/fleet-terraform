...
| [aws_security_group_rule.rds_ecs_ingress](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group_rule) | resource |
...
| <a name="output_rds_clusters"></a> [rds\_clusters](#output\_rds\_clusters) | All named Aurora cluster module outputs. |
...
| <a name="output_rds_password_secret_kms_key_arns"></a> [rds\_password\_secret\_kms\_key\_arns](#output\_rds\_password\_secret\_kms\_key\_arns) | Aurora database password secret KMS key ARNs by cluster configuration name. |
