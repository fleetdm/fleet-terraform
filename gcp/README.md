...
2.  **Create a `terraform.tfvars` file:**
    ...
    **Example `terraform.tfvars.example`:**
    ...
    fleet_config = {
      ...
      # use_h2c                  = true # Set to true to use h2c
    }
...
*   `fleet_config.image_tag`: The Docker image tag for the Fleet version you want to deploy (e.g., `fleetdm/fleet:v4.78.2`).
