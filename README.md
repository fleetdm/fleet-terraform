...
This module supports both Redis and [Valkey](https://valkey.io/) as the ElastiCache engine. Valkey is an open-source, Redis-compatible in-memory data store.
...
## Using Valkey (Recommended for Cost Savings)

To use Valkey instead of Redis, configure the `redis_config` variable:
...
Redis remains the default engine for backwards compatibility:
